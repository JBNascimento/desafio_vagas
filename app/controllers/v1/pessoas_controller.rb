module V1
    class PessoasController < ApplicationController
        ...
        def create
            ...
            if pessoa.save
                render json: {status: 'SUCCESS', message:'Saved pessoa', data:pessoa},status: :ok
            else
                render json: {status: 'ERROR', message:'Pessoa not saved', data:pessoa.errors},status: :unprocessable_entity
            end
        end
        # Excluir pessoa
        def destroy
